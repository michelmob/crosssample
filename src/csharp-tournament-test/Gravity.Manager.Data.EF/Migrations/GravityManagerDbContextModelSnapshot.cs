...
namespace Gravity.Manager.Data.EF.Migrations
{
    ...
    partial class GravityManagerDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gravity.Manager.Data.Entities.ReportLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn);

                    b.Property<long>("AwsInstanceId");
            ...
            modelBuilder.Entity("Gravity.Manager.Data.Entities.ReportLine", b =>
                {
                    b.HasOne("Gravity.Manager.Data.Entities.AwsInstance", "AwsInstance")
                        .WithMany("ReportLines")
                        .HasForeignKey("AwsInstanceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Gravity.Manager.Data.Entities.ReportLine", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
